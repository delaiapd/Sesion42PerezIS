<%-- 
    Document   : index
    Created on : 24/10/2025, 08:35:52 AM
    Author     : delai
--%>

<html>
    <head>
        <title>Pagina  PEREZ Aplicacion WEB SOFTWARE JSP - MYSQL </title>
        <meta charset="UTF-8">
...
<!-----------------------------/BOOTSTRAP----------------------------->
    ...
    <body style="background-color: #D0B3FF">
        <!-- HEADER -------------------------------------------------------------------->
                <header>
                        <!-- MAIN HEADER -->
                        <div id="header">
...
<br>
        <div class="container">
            <center>
                ...
                <h4>LISTA OFICIAL DE USARIOS DE SISTEMA PEREZ</h4>
                <br>
            </center>  
                        ...
                        <div class="col-md-3 col-xs-6">
                            <div class="footer">
                                ...
                                <ul class="footer-links">
                                        ...
                                        <li><i class="fa fa-envelope-o"></i>Delaia Pérez Díaz</li>
                                </ul>
                            </div>
